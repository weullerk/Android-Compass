...
public class CompassView extends View {
    ...
    public CompassView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        markerPaint.setShadowLayer(2, 1, 1, ContextCompat.getColor(c, R.color.shadow_color));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        RadialGradient borderGradient = new RadialGradient(py, py, radius, borderGradientColors, borderGradientPositions, Shader.TileMode.CLAMP);
        ...
        LinearGradient skyShader = new LinearGradient(center.x, innerBoundingBox.top, center.x, innerBoundingBox.bottom, skyHorizonColorFrom, skyHorizonColorTo, Shader.TileMode.CLAMP);

        Paint skyPaint = new Paint();
        skyPaint.setShader(skyShader);

        LinearGradient groundShader = new LinearGradient(center.x, innerBoundingBox.top, center.x, innerBoundingBox.bottom, groundHorizonColorFrom, groundHorizonColorTo, Shader.TileMode.CLAMP);
        ...
        for (double i = 0; i < 360; i+= increment) {
            ...
            if (i % increment == 0)
                ...
                canvas.drawLine(center.x, (int)boundingBox.top, center.x, boundingBox.top + 3, markerPaint);
    ...
    public boolean dispatchPopulateAccessibilityEvent(final AccessibilityEvent event) {
        ...
        if (isShown()) {
            String bearingStr = String.valueOf(event);
